            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="movies">
                        <thead style="background-color: #079ba3; color:white;">
                            <tr>
                                <th>ID</th>
                                <th>Movie Title</th>
 ...
 <div class="modal fade" id="viewmodal"tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  aria-hidden="true"> 
            <div class="modal-dialog" 
                ...
                <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content" >
                            <form method="post" id="save-movie-form" enctype="multipart/form-data" style="background-color: #a5e6e6; color:black;">
                                @csrf
                                <div class="modal-header " >
                ...
                <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form method="post" id="edit-film-form" enctype="multipart/form-data" style="background-color: #a5e6e6; color:black;">
                                @csrf
                                <div class="modal-header">
